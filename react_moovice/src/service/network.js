...
export const getPopularMovies = () => {
    const url = `https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=134d92c3d72c8501356da2496ace8c7e`
    return fetchAndTransformMovies(url)
}
export const getMovie = (id) => {
    const url = `http://api.themoviedb.org/3/movie/${id}?api_key=134d92c3d72c8501356da2496ace8c7e`
